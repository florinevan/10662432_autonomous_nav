...
if("TRUE" STREQUAL "TRUE")
  set(nifti_teleop_SOURCE_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/src/nifti_teleop)
  set(nifti_teleop_DEVEL_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/devel)
  ...
  set(nifti_teleop_INSTALL_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/install)
...
if(NOT "/home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/devel/include " STREQUAL " ")
  set(nifti_teleop_INCLUDE_DIRS "")
  set(_include_dirs "/home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nifti_teleop' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_3d_nav/src/nifti_teleop/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT nifti_teleop_NUM_DUMMY_TARGETS)
      set(nifti_teleop_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nifti_teleop::wrapped-linker-option${nifti_teleop_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nifti_teleop_NUM_DUMMY_TARGETS "${nifti_teleop_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nifti_teleop::wrapped-linker-option${nifti_teleop_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nifti_teleop_LIBRARIES "${interface_target_name}")
