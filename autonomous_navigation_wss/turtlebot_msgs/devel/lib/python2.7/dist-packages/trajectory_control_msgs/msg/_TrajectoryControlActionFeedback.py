...
class TrajectoryControlActionFeedback(genpy.Message):
  _md5sum = "7a926bd77a0b059b6c772f57571ad94f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_9di3I().pack(_x.feedback.timestep, _x.feedback.cmd_vel.linear.x, _x.feedback.cmd_vel.linear.y, _x.feedback.cmd_vel.linear.z, _x.feedback.cmd_vel.angular.x, _x.feedback.cmd_vel.angular.y, _x.feedback.cmd_vel.angular.z, _x.feedback.wheeled_cmd_vel.left, _x.feedback.wheeled_cmd_vel.right, _x.feedback.posture_cmd.data, _x.feedback.flippers_state.header.seq, _x.feedback.flippers_state.header.stamp.secs, _x.feedback.flippers_state.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.timestep, _x.feedback.cmd_vel.linear.x, _x.feedback.cmd_vel.linear.y, _x.feedback.cmd_vel.linear.z, _x.feedback.cmd_vel.angular.x, _x.feedback.cmd_vel.angular.y, _x.feedback.cmd_vel.angular.z, _x.feedback.wheeled_cmd_vel.left, _x.feedback.wheeled_cmd_vel.right, _x.feedback.posture_cmd.data, _x.feedback.flippers_state.header.seq, _x.feedback.flippers_state.header.stamp.secs, _x.feedback.flippers_state.header.stamp.nsecs,) = _get_struct_9di3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
