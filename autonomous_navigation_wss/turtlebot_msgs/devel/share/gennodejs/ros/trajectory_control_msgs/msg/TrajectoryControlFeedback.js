...
class TrajectoryControlFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('wheeled_cmd_vel')) {
        this.wheeled_cmd_vel = initObj.wheeled_cmd_vel
      }
      else {
        this.wheeled_cmd_vel = new nifti_robot_driver_msgs.msg.Tracks();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [wheeled_cmd_vel]
    bufferOffset = nifti_robot_driver_msgs.msg.Tracks.serialize(obj.wheeled_cmd_vel, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [wheeled_cmd_vel]
    data.wheeled_cmd_vel = nifti_robot_driver_msgs.msg.Tracks.deserialize(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '3f08dc129f4905b862e0da5eb5370e54';
  }
  ...
  static messageDefinition() {
    ...
    nifti_robot_driver_msgs/Tracks wheeled_cmd_vel
  ...
  static Resolve(msg) {
    ...
    if (msg.wheeled_cmd_vel !== undefined) {
      resolved.wheeled_cmd_vel = nifti_robot_driver_msgs.msg.Tracks.Resolve(msg.wheeled_cmd_vel)
    }
    else {
      resolved.wheeled_cmd_vel = new nifti_robot_driver_msgs.msg.Tracks()
    }
