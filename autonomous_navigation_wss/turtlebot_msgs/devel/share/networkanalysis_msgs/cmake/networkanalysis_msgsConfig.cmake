...
if("TRUE" STREQUAL "TRUE")
  set(networkanalysis_msgs_SOURCE_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_msgs/src/networkanalysis_msgs)
  set(networkanalysis_msgs_DEVEL_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_msgs/devel)
  ...
  set(networkanalysis_msgs_INSTALL_PREFIX /home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_msgs/install)
...
if(NOT "/home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_msgs/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'networkanalysis_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/florine_van/10662432_autonomous_nav/autonomous_navigation_wss/turtlebot_msgs/src/networkanalysis_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT networkanalysis_msgs_NUM_DUMMY_TARGETS)
      set(networkanalysis_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::networkanalysis_msgs::wrapped-linker-option${networkanalysis_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR networkanalysis_msgs_NUM_DUMMY_TARGETS "${networkanalysis_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::networkanalysis_msgs::wrapped-linker-option${networkanalysis_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND networkanalysis_msgs_LIBRARIES "${interface_target_name}")
