...
#Run 2D SLAM
gnome-terminal --working-directory=$NAV_WSS -e "roslaunch turtlebot_slam_karto turtlebot_slam_karto.launch"
...
do
	...
	then
		...
		kill $TERMPID
		TERMPID=$(ps -ef |grep 'roslaunch turtlebot_slam_karto' |head -1 |awk '{print $2}')
		kill $TERMPID
		EXIT=$(( $EXIT + 1 ))
	fi
done
