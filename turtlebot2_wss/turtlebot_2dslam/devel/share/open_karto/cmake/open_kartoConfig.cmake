...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/src/open_karto)
  set(open_karto_DEVEL_PREFIX /home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/devel)
  ...
  set(open_karto_INSTALL_PREFIX /home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/install)
...
if(NOT "/home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/src/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/src/open_karto/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user001/ROCO506/turtlebot2_wss/turtlebot_2dslam/src/open_karto/${idir}'.  ${_report}")
    endif()
