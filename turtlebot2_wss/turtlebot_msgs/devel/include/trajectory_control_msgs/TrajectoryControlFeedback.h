...
struct TrajectoryControlFeedback_
{
  ...
  _cmd_vel_type cmd_vel;
   ...
   typedef  ::nifti_robot_driver_msgs::Tracks_<ContainerAllocator>  _wheeled_cmd_vel_type;
  _wheeled_cmd_vel_type wheeled_cmd_vel;
...
// {'nav_msgs': ['/opt/ros/kinetic/share/nav_msgs/cmake/../msg'], 'nifti_robot_driver_msgs': ['/home/user001/ROCO506/turtlebot2_wss/turtlebot_msgs/src/nifti_robot_driver_msgs/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg'], 'sensor_msgs': ['/opt/ros/kinetic/share/sensor_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'visualization_msgs': ['/opt/ros/kinetic/share/visualization_msgs/cmake/../msg'], 'trajectory_control_msgs': ['/home/user001/ROCO506/turtlebot2_wss/turtlebot_msgs/devel/share/trajectory_control_msgs/msg']}
...
struct MD5Sum< ::trajectory_control_msgs::TrajectoryControlFeedback_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x3f08dc129f4905b8ULL;
  static const uint64_t static_value2 = 0x62e0da5eb5370e54ULL;
};
...
struct Printer< ::trajectory_control_msgs::TrajectoryControlFeedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::trajectory_control_msgs::TrajectoryControlFeedback_<ContainerAllocator>& v)
  {
    ...
    s << indent << "wheeled_cmd_vel: ";
    s << std::endl;
    Printer< ::nifti_robot_driver_msgs::Tracks_<ContainerAllocator> >::stream(s, indent + "  ", v.wheeled_cmd_vel);
