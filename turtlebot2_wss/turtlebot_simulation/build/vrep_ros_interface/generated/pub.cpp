    ...
    else if(publisherProxy->topicType == "nifti_robot_driver_msgs/TracksStamped")
    {
        nifti_robot_driver_msgs::TracksStamped msg;
        read__nifti_robot_driver_msgs__TracksStamped(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
