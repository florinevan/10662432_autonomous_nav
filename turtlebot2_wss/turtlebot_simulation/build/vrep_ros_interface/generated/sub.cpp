    ...
    else if(in->topicType == "nifti_robot_driver_msgs/TracksStamped")
    {
        subscriberProxy->subscriber = nh->subscribe<nifti_robot_driver_msgs::TracksStamped>(in->topicName, in->queueSize, boost::bind(ros_callback__nifti_robot_driver_msgs__TracksStamped, _1, subscriberProxy));
    }
