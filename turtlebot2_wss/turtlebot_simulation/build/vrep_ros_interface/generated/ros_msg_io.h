...
void write__nifti_robot_driver_msgs__TracksStamped(const nifti_robot_driver_msgs::TracksStamped& msg, int stack, const WriteOptions *opt = NULL);
void read__nifti_robot_driver_msgs__TracksStamped(int stack, nifti_robot_driver_msgs::TracksStamped *msg, const ReadOptions *opt = NULL);
